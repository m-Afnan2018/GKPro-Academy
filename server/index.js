...
// Security & parsing
app.use(helmet());
app.use(cors({ origin: process.env.CLIENT_URL || process.env.CLIENT_URL_WWW || "http://localhost:3000", credentials: true }));
...
connectDB()
  .then(() => {
    ...
    require("./src/services/hlsTranscoder.service").requeueStuckJobs();
  })
  .catch((err) => {
