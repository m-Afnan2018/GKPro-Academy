        ...
        <footer className={styles.footer}>
            <div className={`container ${styles.inner}`}>
                ...
                <div className={styles.col}>
                    ...
                    >
                        <path
                            d="M0 4 Q 6.25 0 12.5 4 T 25 4 T 37.5 4 T 50 4"
                            stroke="#8b5cf6"
                            strokeWidth="1.2"
                            strokeLinecap="round"
                            strokeDasharray="2 3"
                    ...
                    <p className={styles.aboutText}>
                        GKPro Academy is a professional learning platform
                        focused on Chartered Accountancy preparation and
                        practical accounting skill courses.
                    </p>
                </div>
                        ...
                        <div className={styles.followDetails}>
                            <ul className={styles.contactList}>
                                <li>
                                    ...
                                    <a
                                        href="mailto:info@gkproacademy.com"
                                        className={styles.link}
                                    >
                                        info@gkproacademy.com
                                    </a>
                                </li>
                                <li>
                                    <span className={styles.labelRed}>
                                ...
                                <li>
                                    ...
                                    <span>
                                        Vishwa Karma Road, Doraha, Ludhiana,
                                        Punjab, India - 141421
                                    </span>
                                </li>
                            </ul>
            ...
            <div className={styles.bottomBar}>
                <div className={`container ${styles.bottomBarInner}`}>
                    ...
                    <p className={styles.copyright}>
                        Copyright &copy; 2026 GKProAcademy. All Rights Reserved.
                    </p>
                </div>
            </div>
        </footer>
