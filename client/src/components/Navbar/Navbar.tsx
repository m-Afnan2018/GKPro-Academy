        ...
        searchDebounce.current = setTimeout(async () => {
            ...
            try {
                const res = await fetch(
                    `${BASE}/search?q=${encodeURIComponent(val.trim())}&type=all&limit=3`,
                ).then((r) => r.json());
                    ...
                    >
                        ...
                        {coursesOpen && (
                            ...
                            >
                                ...
                                {hoveredCat &&
                                    subcatsFor(hoveredCat._id).length > 0 && (
                                        <div className={styles.megaRight}>
                                            <p className={styles.megaHeading}>
                                                {hoveredCat.name}
                                            </p>
                                            <div className={styles.megaSubGrid}>
                                                {subcatsFor(hoveredCat._id).map(
                                                    (sub) => (
                                                        <Link
                                                            key={sub._id}
                                                        ...
                                                        {quickResults!.courses.map(
                                                            (c) => (
                                                                ...
                                                                >
                                                                    ...
                                                                    <div
                                                                        className={
                                                                            styles.quickItemBody
                                                                        }
                                                                    >
                                                                        <span
                                                                            className={
                                                                                styles.quickItemTitle
                                                                            }
                                                                        >
                                                                            {
                                                                                c.title
                                ...
                                {categories.map((cat) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            {subs.length > 0 && (
                                                <div
                                                    className={`${styles.mobileNestedWrap} ${isExpanded ? styles.expanded : ""}`}
                                                >
                                                    <div
                                                        className={
                                                            styles.mobileNestedInner
                                                        }
                                                    >
                                                        <ul
                                                            className={
                                                                styles.mobileNestedList
                                                            }
                                                        >
                                                            {subs.map((sub) => (
                                                                <li
